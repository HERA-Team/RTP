...
from convert import gcal_to_jd
...
def get_set_strings():
    ...
    filetype_strs = ('uv', 'uvcRRE', 'npz', 'uvc', 'uvcR', 'uvcRE')
...
def get_dropdowns():
    ...
    '''
    pol_dropdown = (('all', 'all'), ('xx', 'xx'), ('xy', 'xy'),
                    ('yx', 'yx'), ('yy', 'yy'), ('any', 'any'))
...
def get_jd_from_datetime(start_time=None, end_time=None):
    ...
    if start_time is not None:
        time_start = gcal_to_jd(start_time.year, start_time.month, start_time.day,
                                start_time.hour, start_time.minute, start_time.second)
    if end_time is not None:
        time_end = gcal_to_jd(end_time.year, end_time.month, end_time.day,
